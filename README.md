This repo is just for practice Java. It will contains challenges that I'll be completing. These are the challenges that I'll be practicing.

They are in spanish because I got the challenges from [here](`https://github.com/mouredev/Weekly-Challenge-2022-Swift`), he is posting 1 new challenge each week and he is from Spain.
